## ⚾([BOJ](https://www.acmicpc.net) 17281)

## 풀이

순열과 야구 규칙을 활용한 시뮬레이션 문제입니다.
3아웃일 때 이닝이 종료되고, 아니면 계속 정해진 순서로 선수들이 플레이합니다.
안타를 칠 때마다 한 칸씩 밀어주는데, 배열을 오른쪽으로 밀어줄 때는 역순으로 해야 정보 누락이 없습니다.
홈런일 때는 안타친 선수들부터 돌린 후 +1을 추가합니다.
